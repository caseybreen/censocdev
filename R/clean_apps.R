...
clean_apps <- function(numapp.file.path = "/global/scratch/p2p3/pl1_demography/censoc_internal/data/numident/1_numident_files_with_original_varnames/applications_original.csv") {
  ...
  columns.to.keep <- c("NUMI_SSN", "NUMI_CITIZENSHIP_CODE", "NUMI_CYCLE_DATE", "NUMI_ENTRY_CODE", "NUMI_DOB", "NUMI_SEX",
                       ...
                       "NUMI_MTH_NAME_LAST", "NUMI_FTH_NAME_FIRST", "NUMI_FTH_NAME_MIDDLE", "NUMI_FTH_NAME_LAST", "NUMI_POB_CITY", "NUMI_SIG_NAME_CODE", "NUMI_POB_CITY_OFLO")
  ...
  variable.names <- c("ssn" = "NUMI_SSN",
             ...
             "form_signer" = "NUMI_SIG_NAME_CODE")
