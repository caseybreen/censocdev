...
\textbf{Update: changed website address from /website to /website_vignettes}
...
Geographic heterogeneity in levels of health and mortality is well documented (\textbf{Update: parallel's phrasing later in vignettte}). Can we see any state-level variation in life expectancy at age 65 in the CenSoc-DMF Demo dataset? 
...
\textbf{Update: Adjusted phrasing at the end of the paragraph}  
...
\textbf{Update: made some changes to this paragraph. Maybe we want an in text citation for the "instructions to enumeration"}  
