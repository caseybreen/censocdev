...
![](figures/manhattan_e65_2.1.png){width=100%}
...
Appropriate regression coefficient adjustments can be found through simulation. Please see [BUNMD working paper](https://www.jstor.org/stable/pdf/48708275.pdf?refreqid=excelsior%3Af4df6d1cc6ad3f1a95ac831919ab7d8f&ab_segments=&origin=&initiator=&acceptTC=1) for more information. 
