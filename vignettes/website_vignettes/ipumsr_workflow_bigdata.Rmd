...
censoc_numident_linked<-read_csv("/data/josh/CenSoc/data_release_demo_v2.1/censoc_dmf_demo_v2.1.csv") # Ben
```
...
ipums_ddi<-"https://live.usa.datadownload.ipums.org/web/extracts/usa/1919330/usa_00005.xml"
