...
```{r, eval = F}
## read in censoc file
censoc <- read_csv("~/path/to/censoc/censoc_numident_v1.csv")
...
Even if you have already read in and linked your CenSoc file to the 1940 census **not** using one of the above approaches, you can still assign meaningful value labels to the linked file — just use the `ipums_collect()` function. 
