...
Summary: Assessing match quality for women in the CenSoc-Numident (V2) file. 
...
numident_death_prop <- read_csv(here("vignettes/assess_match_quality/data/numident_women_death_prop.csv")) %>% 
...
## save plot 
ggsave(numident_match_rate_combined, filename = here("vignettes/assess_match_quality/figs/w_numident_raw_match_rate.pdf"), height = 4, width = 10)
```
...
matched_characteristics_plot_standard <- matched_characteristics_combined %>% 
  ...
  facet_wrap(~type) + 
  background_grid() + 
  labs(title = "CenSoc-Numident: Comparison of Socioeconomic Characteristics (Women)",
       y = "Proportion",
       x = "Age")

## save plot 
ggsave(matched_characteristics_plot_standard, filename = here("vignettes/assess_match_quality/figs/w_numident_socioeconomic_characteristics.pdf"), height = 7, width = 10)
```
...
table_s3 %>%
  gtsave("w_numident_characteristics_table.tex", path = here("vignettes/assess_match_quality/figs/")) 
```
...
, filename = here("vignettes/assess_match_quality/figs/w_numident_match_rate_subgroups.pdf"), height = 4, width = 13)
```
