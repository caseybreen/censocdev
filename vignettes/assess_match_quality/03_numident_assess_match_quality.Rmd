...
## save plot 
ggsave(numident_match_rate, filename = here("vignettes/assess_match_quality/figs/numident_raw_match_rate_women.pdf"), height = 7, width = 10)
```
...
## save plot 
ggsave(matched_characteristics_plot_standard, filename = here("vignettes/assess_match_quality/figs/numident_matched_characteristics_plot_standard_women.pdf"), height = 7, width = 10)

## save plot 
ggsave(matched_characteristics_plot_conservative, filename = here("vignettes/assess_match_quality/figs/numident_matched_characteristics_plot_conservative_women.pdf"), height = 7, width = 10)
```
...
## save table 
numident_characteristics_table %>%
  gtsave("numident_characteristics_women.tex", path = here("vignettes/assess_match_quality/figs/")) 
```
