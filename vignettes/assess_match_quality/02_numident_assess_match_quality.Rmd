...
Summary: Assessing match quality in the CenSoc-Numident (V2) file. 
...
matched_characteristics_plot_standard <- matched_characteristics_combined %>% 
  ...
  facet_wrap(~type) + 
  background_grid() + 
  labs(title = "CenSoc-Numident: Comparison of Socioeconomic Characteristics",
       y = "Proportion",
       x = "Age")
...
, filename = here("vignettes/assess_match_quality/figs/numident_match_rate_subgroups.pdf"), height = 3, width = 14)
```
