...
## save plot 
ggsave(middle_initial_plot, filename = here("vignettes/assess_match_quality/figs/middle_initial_plot.pdf"), height = 5, width = 7)
```

```{r}
 middle_initial_agreement <- censoc_numident_middle %>% 
    filter(link_abe_exact_conservative == 1) %>% 
...
## save plot 
ggsave(association_between_educ_and_longevity, filename = here("vignettes/assess_match_quality/figs/numident_association_between_educ_and_longevity.pdf"), height = 5, width = 7)
```
