...
# censoc_dmf_v2.1 <- read_csv("/data/josh/CenSoc/data_release_v2.1/dmf_v2.1/censoc_dmf_v2.1.csv")
censoc_dmf_v2.1<-read_csv("~censoc_dmf_demo_v2.1.csv") # DMF file I created in codebook demo
# censoc_dmf_v2.1;censoc_dmf_v2.1b
# censoc_dmf_v2.1<-censoc_dmf_v2.1 %>% 
#   inner_join(censoc_dmf_v2.1b, by = c("HISTID" = "histid", "byear", "bmonth","dyear", "dmonth", "death_age", "weight"))
```
...
**Label**: Sample Weights \footnote{The IPUMS-USA 1940 1% sample also includes a weight (`perweight`) to account for the 1940 sampling procedure (thus no weights for the 100% complete count 1940 census). For analysis, we recommend using both sets of weights. A final weight can be constructed by multiplying the two weights together.}  
