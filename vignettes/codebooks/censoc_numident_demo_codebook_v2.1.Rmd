...
|   \hyperlink{page.19}{19}  | \hyperlink{page.19}{link\_abe\_exact\_conservative} |Flag for conservative ABE match |
|   \hyperlink{page.20}{20}  | \hyperlink{page.20}{weight}        |CenSoc weight                                 |
|   \hyperlink{page.21}{21}  | \hyperlink{page.21}{weight\_conservative} |CenSoc weight (Conservative Sample)  |
|   \hyperlink{page.22}{22}  | \hyperlink{page.22}{Additional IPUMS variables}| Additional variables include pernum, perwt, age, mbpl, fbpl, educd, empstatd, hispan, inconwg, marst, nativity, occ, occscore, ownership, race, rent, serial, statefip, urban|  
