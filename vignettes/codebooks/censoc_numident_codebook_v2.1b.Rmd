...
|   \hyperlink{page.4}{4}  | \hyperlink{page.4}{byear}         |Year of birth                                 |
|   \hyperlink{page.5}{5}  | \hyperlink{page.5}{bmonth}        |Month of birth                                |
|   \hyperlink{page.6}{6}  | \hyperlink{page.6}{dyear}         |Year of death                                 |
|   \hyperlink{page.7}{7}  | \hyperlink{page.7}{dmonth}        |Month of death                                |
|   \hyperlink{page.8}{8}  | \hyperlink{page.8}{death\_age}    |Age at death (years)                          |
...
|  \hyperlink{page.16}{16} |\hyperlink{page.16}{bpl}              |Place of Birth                             |
|  \hyperlink{page.18}{18} |\hyperlink{page.18}{zip\_residence}    |ZIP Code of Residence at Time of Death     |
|  \hyperlink{page.19}{19} |\hyperlink{page.19}{socstate}         |State where Social Security Number Issued  |
|  \hyperlink{page.20}{20} |\hyperlink{page.20}{age\_first\_application}    |Age at First Social Security Application   |
|   \hyperlink{page.21}{21}  | \hyperlink{page.21}{link\_abe\_exact\_conservative} |Flag for conservative ABE match |
|   \hyperlink{page.22}{22}  | \hyperlink{page.22}{weight}        |CenSoc weight                                 |
|   \hyperlink{page.23}{23}  | \hyperlink{page.23}{weight\_conservative} |CenSoc weight (Conservative Sample)  |
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{pernum} |Person number in sample weight|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{perwt} |IPUMS person weight|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{age} |Age in 1940|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{mbpl} |Mother's place of birth|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{fbpl} |Father's place of birth|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{educd} |Educational attainment (detailed)|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{empstatd} |Employment status (detailed)|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{hispan} |Hispanic/Spanish/Latino origin|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{inconwg} |Had non-wage/salary income over $50|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{marst} |Marital status|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{nativity} |Foreign birthplace or parentage|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{occ} |Occupation|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{occscore} |Occupational income score|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{ownership} |Ownership of dwelling (tenure)|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{race} |Race|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{rent} |Montly contract rent|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{serial} |Household serial number|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{statefip} |State of residence 1940|
|   \hyperlink{page.24}{24}  | \hyperlink{page.24}{urban} |Urban/rural status|
...
knitr::kable(list(bpl_tabulation[rows,1:4],
      ...
      label = "tables", format = "latex", longtable = T, booktabs = TRUE) %>% 
