...
knitr::opts_knit$set(root.dir = '~mariaosborne/censoc/BUNMD_codebook/bunmd_v2/')
```
...
**Description**: mother_lname is a character variable reporting the first 21 letters of the person's mother's last name, as recorded in the Numident application records.
...
\begin{figure}[H]
\centering
\includegraphics[width=16cm]{codebook_illustrations/weights_lexis.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=16cm]{codebook_illustrations/ccweights_lexis.png}
