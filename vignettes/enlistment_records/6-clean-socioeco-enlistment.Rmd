...
#This rmd recodes race, branch_codes,source, branch_alpha, grade_alpha,
...
```{r }
path_to_temp_data   <-  "/data/josh/CenSoc/censoc_data/enlistment-records-public/code/aw enlistment code/temp5.csv"
out_path <- "/data/josh/CenSoc/censoc_data/enlistment-records-public/code/aw enlistment code"
race_path <- "/data/josh/CenSoc/censoc_data/enlistment-records-public/code/aw enlistment code/titlesnicknames/cl_2059.csv"
```
...
recode_race_enlistment <- function(df){
  ...
  df <- df %>% 
    mutate(race_recode = case_when(
      race == "1" ~ 1, #white citizens/noncitizens
      race == "J" ~ 1, #white citizens/noncitizens
      race == "2" ~ 2, #Black/African American citizens/noncitizens
      race == "K" ~ 2, #Black/African American citizens/noncitizens
      race == "6" ~ 3, #American Indian citizens/noncitizens
      race == "O" ~ 3, #American Indian citizens/noncitizens
      race == "3" ~ 4, #Chinese citizen/noncitizen
      race == "L" ~ 4, #Chinese citizen/noncitizen
      race == "4" ~ 5, #Japanese citizen/noncitizen
      race == "M" ~ 5, #Japanese citizen/noncitizen
      race == "7" ~ 6, #Other Asian/Pacific Islander citizen/noncitizen
      race == "P" ~ 6, #Other Asian/Pacific Islander citizen/noncitizen
      race == "5" ~ 6, #Other Asian/Pacific Islander citizen/noncitizen
      race == "N" ~ 6, #Other Asian/Pacific Islander citizen/noncitizen
      race == "8" ~ 7, #Other + Puerto Ricans
      race == "Q" ~ 7, #Other + Puerto Ricans
      race == "9" ~ 7, #Other + Puerto Ricans
      race == "R" ~ 7, #Other + Puerto Ricans
...
```{r}
data_combined <- cbind(data_combined, race_recode$race_recode, education_recode$education_recode, marital_status_recode$marital_status_recode)
```
