...
```{r, eval = F}
# To avoid running the above code, we cn just read the file read in ss5_applications and ss5_deaths (optional
...
ss5 <- merge_numapp_numdeath(numapp = ss5_application, numdeath = ss5_death, census_year = 1940)
