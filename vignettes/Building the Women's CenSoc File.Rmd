...
ss5 <- merge_numapp_numdeath(numapp = ss5_application, numdeath = ss5_death, census_year = 1930)

## Or just read in the numapp_numdeath file: 
ss5 <- fread("/data/josh/CenSoc/ss5_data/merged_application_death/ss5_merged_with_numdeath.csv")
```

## Load Census File

```{r, eval = F}
# census <- load_census(census_file = "../../IPUMS/1930/CSV/P.csv")

## Load census with HISTID
census_2019 <- load_census(census_file = "../../../casey-ipums/IPUMS2019/1930/TSV/P.tsv")
```

## Merge SS-5 and Census Files on linking keys
```{r, eval = F}
wcensoc_1930 <- census_ss5_merge(ss5 = ss5, census = census_2019)

wcensoc_1930_cleaned <- clean_wcensoc(wcensoc_1930, census_year = 1930)

fwrite(wcensoc_1930_cleaned, "../../ipums/casey-ipums/censoc_male_and_female_sample_matched_with_census_1930.csv")

wcensoc <- fread("../../ipums/casey-ipums/censoc_male_and_female_sample_matched_with_census_1930.csv")
```
