...
```{r}
wcensoc <- fread("../../censoc_male_and_female_sample_matched_with_census_1930.csv")


## Select variables of interest
wcensoc_names <- male_female_1930 %>%
  select(NAMEFRST, mname, SEX, MARST, dyear, byear)


test <- census %>% sample_n(100) %>% 
  select(HISTID, NAMEFRST)
```
