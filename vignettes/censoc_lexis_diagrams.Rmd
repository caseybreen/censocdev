...
```{r}
censoc_male_sample <- fread("/90days/casey/censoc_id_date_v2.csv")
...
```{r}
censoc_female_and_male_sample <- fread("/home/ipums/casey-ipums/censoc_female_and_male_sample_matched_with_census.csv")
