...
| \hyperlink{page.16}{16}     | \hyperlink{page.15}{death\_ruc1993}          |place of death, county rural-urban continuum  |
...
combined_plot <- birth_year_match_combined_gender %>%
  ...
  labs(title = "Matched Death ZIP to County by Gender and Cohort", x = "Birth Year", y = "Proportion of BUNMD Records") +
  theme_cowplot() +
