...
censoc_numident_v2.1 <- read_csv("/global/scratch/p2p3/pl1_demography/censoc/censoc_data_releases/censoc_numident/censoc_numident_v2.1/censoc_numident_v2.1.csv")
```
