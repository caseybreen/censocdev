---
title: "CenSoc-DMF Demo Codebook (V2.1)[^updated]"
output:
...
|   \hyperlink{page.11}{11}  | \hyperlink{page.11}{educ\_yrs} |Educational attainment in years (constructed)|
...
**Summary**: The CenSoc-DMF Version 2.1 Demo dataset (N = 70,211) links the IPUMS 1940 1% census sample to the Death Master File (DMF) dataset, a collection of death records reported to the Social Security Administration.  Records were linked using the standard and conservative ABE method developed by Abramitzky, Boustan, and Eriksson ([2012](https://ranabr.people.stanford.edu/sites/g/files/sbiybj5391/f/abe_ageofmassmigration.pdf), [2014](https://ranabr.people.stanford.edu/sites/g/files/sbiybj5391/f/abe_assimilation_1.pdf), [2017](https://ranabr.people.stanford.edu/sites/g/files/sbiybj5391/f/return-migrants.pdf)). Note, the demo file isn’t conducive to high-resolution mortality research, and we recommend researchers obtain a copy of the 1940 Census from IPUMS-USA and link on the individual-level, unique identifier HISTID variable. 
...
censoc_dmf_v2.1<-read_csv("/global/scratch/p2p3/pl1_demography/censoc/censoc_data_releases/censoc_dmf_demo/censoc_dmf_demo_v2.1/censoc_dmf_demo_v2.1.csv")
```
