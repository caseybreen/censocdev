---
title: CenSoc-Numident Demo Codebook (V2.1)[^updated]
output:
...
censoc_numident_v2.1<-read_csv("/global/scratch/p2p3/pl1_demography/censoc/censoc_data_releases/censoc_numident_demo/censoc_numident_demo_v2.1/censoc_numident_demo_v2.1.csv")
```
