...
censoc_dmf_v2.1<-read_csv("/data/censoc/censoc_data_releases/censoc_dmf_demo/...")
```
...
Please see the CenSoc Methods Protocol for more details on weighting procedure.  
