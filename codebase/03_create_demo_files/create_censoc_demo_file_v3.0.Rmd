...
vars_to_keep_num <- c("histid", "byear", "bmonth", "dyear", "dmonth", "death_age", "race_first", "race_first_cyear", "race_last", "bpl_string", "zip_residence", "socstate", "socstate_string", "age_first_application", "weight",  "perwt", "age", "sex", "bpl", "mbpl", "fbpl", "educd", "educ_yrs", "empstatd", "hispan", "incnonwg", "incwage", "marst", "nativity", "occ", "occscore",  "pernum", "race", "serial")
...
vars_to_keep_dmf <- c("histid", "byear", "bmonth", "dyear", "dmonth", "death_age", "weight", "perwt", "age", "sex", "bpld", "mbpl", "fbpl", "educd", "educ_yrs", "empstatd", "hispan", "incnonwg", "incwage", "marst", "nativity", "occ", "occscore",  "pernum", "race",  "serial")
