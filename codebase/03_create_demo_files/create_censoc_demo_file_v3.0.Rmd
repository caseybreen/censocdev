...
vars_to_keep_dmf <- c("histid", "byear", "bmonth", "dyear", "dmonth", "death_age", "weight", "pernum", "perwt", "age", "sex", "bpld", "mbpl", "fbpl", "educd", "educ_yrs", "empstatd", "hispan", "incwage", "incnonwg", "marst", "nativity", "occ", "occscore", "ownershp", "race", "serial", "statefip", "urban")
...
Write Files
```{r}
demo_file_dmf <- demo_file_dmf %>% rename(HISTID = histid)
demo_file_numident <- demo_file_numident %>% rename(HISTID = histid)
...
# should do a little testing to make sure that nothing went terribly wrong in the linking process.
