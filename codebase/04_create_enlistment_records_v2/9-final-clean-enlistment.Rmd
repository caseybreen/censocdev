...
enlistment_records_final_v1 <- enlistment_records_final_v1 %>% 
        rename("sex" ="sex_r" , 
              "date_of_enlistment_yyyymmdd"= "date_enlistment_recode",
               "yob" = "yob_precise" ,
               "fname" = "fname_clean",
               "mname" = "mname_clean",
               "lname" = "lname_clean",
               "place_of_birth" = "nativity_recode$nativity_recode" ,
