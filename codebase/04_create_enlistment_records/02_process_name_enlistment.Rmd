...
```{r}
path_to_temp_data <- "/data/censoc/workspace/enlistment_records/temp1.csv"
outpath <- "/data/censoc/workspace/enlistment_records/"
tan_path   <- "/data/josh/CenSoc/censoc_data/enlistment-records-public/data/codes/titles-and-nicknames" # should update at some point
```
