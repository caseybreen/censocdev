...
in_path_B      <- "/home/ipums/mariaosborne-ipums/enlistment_records_linking/enlistment-males-by-bpl/"
fname_var_A    <- "fname"
fname_var_B    <- "fname"
lname_var_A    <- "lname"
lname_var_B    <- "lname"
...
out_path       <- "/home/ipums/mariaosborne-ipums/enlistment_records_linking/matched-enlistment-census"
log_path       <- "/home/ipums/mariaosborne-ipums/enlistment_records_linking/log"

path_to_out_file <- paste0(log_path, "/run-match-records_1.log")
