---
title: "CenSoc WWII Army Enlistment Dataset Codebook[^updated]"
output:
...
**Description:** fname is a character variable reporting a person’s first name, as recorded in the World War II Army Enlistment Records. This variable was cleaned from raw first names by removing non-alphabetical characters, whitespace, and titles (e.g., Dr.).
...
**Description**: place_of_enlistment is a character variable that reports the place a person was enlisted, as reported in the World War II Army Enlistment Records. 
