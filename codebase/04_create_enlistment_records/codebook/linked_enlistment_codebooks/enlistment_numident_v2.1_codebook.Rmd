---
title: "CenSoc Enlistment-Numident V2.1 Codebook[^updated]"
output:
...
| Page| Variable     | Label                                        |
|----:|:-------------------------------|:---------------------------------------------|
|  \hyperlink{page.3}{3}  | \hyperlink{page.3}{id}         | Unique Identifier  |
|   \hyperlink{page.4}{4}  |\hyperlink{page.4}{sex}             |Sex              |
|   \hyperlink{page.5}{5} |\hyperlink{page.5}{bpl}              |Place of Birth |
|   \hyperlink{page.6}{6}  | \hyperlink{page.6}{byear\_numident}      |Year of Birth (Numident)   |
|   \hyperlink{page.7}{7}  | \hyperlink{page.7}{bmonth\_numident}           |Month of Birth      |
|   \hyperlink{page.8}{8}  |\hyperlink{page.8}{dyear\_numident}            |Year of Birth        |
|   \hyperlink{page.9}{9}  | \hyperlink{page.9}{dmonth\_numident}          |Month of Birth     |
|   \hyperlink{page.10}{10}  |\hyperlink{page.10}{death\_age\_numident}          |Age at Death (Years)    |
|   \hyperlink{page.11}{11}   |\hyperlink{page.11}{race\_first\_numident}          |Race on First Application   |
|  \hyperlink{page.12}{12} |\hyperlink{page.12}{race\_first\_cyear\_numident}     |First Race: Application Year   |
|  \hyperlink{page.13}{13} |\hyperlink{page.13}{race\_first\_cmonth\_numident}    |First Race: Application Month    |
|  \hyperlink{page.14}{14} |\hyperlink{page.14}{race\_last\_numident}           |Race on Last Application    |
|  \hyperlink{page.15}{15} |\hyperlink{page.15}{race\_last\_cyear\_numident}      |Last Race: Application Year    |
|  \hyperlink{page.16}{16} |\hyperlink{page.16}{race\_last\_cmonth\_numident}     |Last Race: Application Month |
|  \hyperlink{page.17}{17} |\hyperlink{page.17}{zip\_residence\_numident}   |ZIP Code of Residence at Time of Death  |
|  \hyperlink{page.18}{18} |\hyperlink{page.18}{socstate\_numident}      |State where Social Security Number was Issued  |
|  \hyperlink{page.19}{19} |\hyperlink{page.19}{age\_first\_application\_numident}  |Age at First Social Security Application |
|   \hyperlink{page.20}{20}  | \hyperlink{page.20}{byear\_enlistment}           |Year of Birth (Enlistment)    |
|   \hyperlink{page.21}{21}  | \hyperlink{page.21}{date\_of\_enlistment\_enlistment}  |Date of Enlistment     |
|  \hyperlink{page.22}{22} |\hyperlink{page.22}{residence\_state\_enlistment}   |State of Residence at Enlistment|
|  \hyperlink{page.23}{23} |\hyperlink{page.23}{residence\_state\_fips\_enlistment}           |State FIPS Code of Residence at Enlistment|
|  \hyperlink{page.24}{24} |\hyperlink{page.24}{residence\_county\_fips\_enlistment}   |County FIPS Code of Residence at Enlistment|
|  \hyperlink{page.25}{25} |\hyperlink{page.25}{place\_of\_enlistment\_enlistment}   |Place of Enlistment|
|  \hyperlink{page.26}{26} |\hyperlink{page.26}{education\_enlistment}     |Education |
|  \hyperlink{page.27}{27} |\hyperlink{page.27}{grade\_code\_enlistment}    |Army Grade (Rank)|
|  \hyperlink{page.28}{28} |\hyperlink{page.28}{branch\_code\_enlistment}       |Army Branch |
|  \hyperlink{page.30}{30} |\hyperlink{page.30}{term\_of\_enlistment\_enlistment}    |Term of Enlistment |
|  \hyperlink{page.31}{31} |\hyperlink{page.31}{race\_enlistment}    |Race  |
|  \hyperlink{page.32}{32} |\hyperlink{page.32}{citizenship\_enlistment}     |Citizenship  |
|  \hyperlink{page.33}{33} |\hyperlink{page.33}{civilian\_occupation\_enlistment}    |Civilian Occupation |
|  \hyperlink{page.34}{34} |\hyperlink{page.34}{marital\_status\_enlistment}     |Marital Status at Enlistment |
|  \hyperlink{page.35}{35} |\hyperlink{page.35}{height\_enlistment}       |Height at Enlistment (Inches) |
|  \hyperlink{page.36}{36} |\hyperlink{page.36}{weight\_before\_march\_1943\_enlistment}   |Weight (Pounds)|
|  \hyperlink{page.37}{37} |\hyperlink{page.37}{weight\_or\_AGCT\_enlistment}      |Weight (Pounds) or AGCT Score|
|  \hyperlink{page.38}{38} |\hyperlink{page.38}{component\_enlistment}  |Army Component |
|  \hyperlink{page.39}{39} |\hyperlink{page.39}{source\_enlistment}      |Source of Army Personnel |
|  \hyperlink{page.40}{40} |\hyperlink{page.40}{enlistment\_status\_enlistment}         |Status of Enlistment|
|  \hyperlink{page.41}{41}  | \hyperlink{page.41}{HISTID}         |HISTID (1940 Census)  |

**Summary:** The CenSoc Enlistment-Numident file links 1,693,544 men from World War II era army enlistment records (circa 1938-1947) to mortality records in the Berkeley Unified Numident Mortality Database (BUNMD). The suffix on each variable indicates whether the variable comes from Numident (BUNMD) records or from army enlistment records. For enlistment records that have been independently and additionally linked to the 1940 Census, we include the HISTID identifier variable that researchers may use to merge this dataset with IPUMS 1940 Census data. Matches between datasets were established using a conservative variant of the ABE method developed by Abramitzky, Boustan, and Eriksson ([2012](https://ranabr.people.stanford.edu/sites/g/files/sbiybj26066/files/media/file/abe_ageofmassmigration.pdf), [2014](https://ranabr.people.stanford.edu/sites/g/files/sbiybj26066/files/media/file/abe_assimilation_1.pdf), [2017](https://ranabr.people.stanford.edu/sites/g/files/sbiybj26066/files/media/file/return-migrants.pdf)).
...
#data_path <- '~mariaosborne-ipums/enlistment_records_linking/matched_enlistment_datasets_v1.1/public_numident_enlistment_links_males.csv'
data_path <-"/global/scratch/p2p3/pl1_demography/censoc/censoc_data_releases/army_enlistment_numident/enlistment_numident_v2.1/public_numident_enlistment_links_males.csv.gz"
...
education_tabulated <- knitr::kable(data_records %>%
    group_by(education_enlistment) %>%
     tally() %>%
     mutate(freq = round(n*100 / sum(n), 2)) %>%
     mutate(label = c( "Grammar school or less than grade 9" , "Grade 9", "Grade 10", "Grade 11", "Grade 12", "1 year of college	", "2 years of college", "3 years of college" ,"	4 years of college", "5+ years of college")) %>%
...
odes, please see: https://aad.archives.gov/aad/popup-codelist.jsp?cl_id=3323&dt=893&c_id=24986
