...
|  \hyperlink{page.27}{27} |\hyperlink{page.27}{term\_of\_enlistment\_enlistment}    |Term of Enlistment |
|  \hyperlink{page.28}{28} |\hyperlink{page.28}{race\_enlistment}    |Race  |
|  \hyperlink{page.29}{29} |\hyperlink{page.29}{citizenship\_enlistment}     |Citizenship  |
|  \hyperlink{page.30}{30} |\hyperlink{page.30}{civilian\_occupation\_enlistment}    |Civilian Occupation |
|  \hyperlink{page.31}{31} |\hyperlink{page.31}{marital\_status\_enlistment}     |Marital Status at Enlistment |
|  \hyperlink{page.32}{32} |\hyperlink{page.32}{height\_enlistment}       |Height at Enlistment (inches) |
|  \hyperlink{page.33}{33} |\hyperlink{page.33}{weight\_before\_march\_1943\_enlistment}   |Weight (pounds)|
|  \hyperlink{page.34}{34} |\hyperlink{page.34}{weight\_or\_AGCT\_enlistment}      |Weight (pounds) or AGCT score|
|  \hyperlink{page.35}{35} |\hyperlink{page.35}{component\_enlistment\_enlistment}  |Army component |
|  \hyperlink{page.36}{36} |\hyperlink{page.36}{source\_enlistment}      |Source of Army Personnel |
| \hyperlink{page.37}{37}  | \hyperlink{page.37}{HISTID}         |HISTID (1940 Census)  |

**Summary:** The CenSoc Enlistment-Numident file links 1,692,279 men from World War II era (circa 1938-1947) army enlistment records to mortality records in the Berkeley Unified Numident Mortality Database (BUNMD). The suffix on each variable inidicates if the variable comes from Numident (BUNMD) records or army enlistment records. For enlistment records that have been independently linked to the 1940 census, we include the HISTID identifier variable that researchers may use to merge this data set with IPUMS 1940 census data. Matches between datasets were established using the conservative variant of the ABE method developed by Abramitzky, Boustan, and Eriksson ([2012](https://ranabr.people.stanford.edu/sites/g/files/sbiybj5391/f/abe_ageofmassmigration.pdf), [2014](https://ranabr.people.stanford.edu/sites/g/files/sbiybj5391/f/abe_assimilation_1.pdf), [2017](https://ranabr.people.stanford.edu/sites/g/files/sbiybj5391/f/return-migrants.pdf)).
...
data_path <- '~mariaosborne-ipums/enlistment_records_linking/matched_enlistment_datasets/public_numident_enlistment_links_males.csv'
...
**Description**: id is an 11-digit string that uniquely identifies each records in the dataset.
...
**Description**: bpl is a numeric variable that reports a person's place of birth, as reported in the World War II Army Enlistment Records and Numident death records
...
**Description:** bmonth_ reports a person's month of birth, as recorded in the Numident. 
...
**Description**: dyear reports a person's year of death, as recorded in the Numident.    
...
**Description**: residence_state_enlistment is a character variable that reports a person's state of residence at time of enlistment, as reported in the World War II Army Enlistment Records. This variable is only available for enlistees residing in the US.
...
**Description**: residence_county_enlistment is a character variable that reports a person's county of residence at time of enlistment, as reported in the World War II Army Enlistment Records. This variable is only available for enlistees residing in the US.
...
**Description**: grade_code_enlistment is a numeric variable that records a person's grade (rank), as reported in the World War II Army Enlistment Records. 
