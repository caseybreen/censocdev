...
|  \hyperlink{page.36}{36} |\hyperlink{page.36}{component\_enlistment\_enlistment}  |Army Component |
...
**Description**: id is a generated 11-digit string that uniquely identifies each records in the dataset.
...
**Description**: bpl is a numeric variable that reports a person's place of birth, as reported in the World War II Army Enlistment Records and Numident records.
