---
title: "CenSoc Enlistment-Census-1940 V1.1 Codebook [^updated]"
output:
...
|  \hyperlink{page.8}{8} |\hyperlink{page.8}{residence\_state\_fips}           |State FIPS Code of Residence at Enlistment|
|  \hyperlink{page.9}{9} |\hyperlink{page.9}{residence\_county\_fips}           |County FIPS Code of Residence at Enlistment|
|  \hyperlink{page.10}{10} |\hyperlink{page.10}{place\_of\_enlistment}          |Place of Enlistment|
|  \hyperlink{page.11}{11} |\hyperlink{page.11}{education}                   |Education |
|  \hyperlink{page.12}{12} |\hyperlink{page.12}{grade\_code}                    |Army Grade (Rank)|
|  \hyperlink{page.13}{13} |\hyperlink{page.13}{branch\_code}                     |Army Branch |
|  \hyperlink{page.15}{15} |\hyperlink{page.15}{term\_of\_enlistment}            |Term of Enlistment |
|  \hyperlink{page.16}{16} |\hyperlink{page.16}{race}    |Race  |
|  \hyperlink{page.17}{17} |\hyperlink{page.17}{citizenship}                 |Citizenship  |
|  \hyperlink{page.18}{18} |\hyperlink{page.18}{civilian\_occupation}            |Civilian Occupation |
|  \hyperlink{page.19}{19} |\hyperlink{page.19}{marital\_status}            |Marital Status at Enlistment |
|  \hyperlink{page.20}{20} |\hyperlink{page.20}{height}                |Height at Enlistment (Inches) |
|  \hyperlink{page.21}{21} |\hyperlink{page.21}{weight\_before\_march\_1943}                |Weight (Pounds)|
|  \hyperlink{page.22}{22} |\hyperlink{page.22}{weight\_or\_AGCT}                |Weight (Pounds) or AGCT score|
|  \hyperlink{page.23}{23} |\hyperlink{page.23}{component}             |Army Component |
|  \hyperlink{page.24}{24} |\hyperlink{page.24}{source}                          |Source of Army Personnel |
|  \hyperlink{page.25}{25} |\hyperlink{page.25}{enlistment\_status}                          |Status of Enlistment|

**Summary:** The CenSoc Enlistment-Census-1940 file links 2,573,830 men from World War II era army enlistment records (circa 1938-1947) to the 1940 Census. We include the HISTID identifier to allow researchers to merge this file with IPUMS 1940 Census data. All variables included here, such as marital status and education, were measured at time of enlistment and are not taken from census data. Matches between datasets were established using a conservative variant of the ABE method developed by Abramitzky, Boustan, and Eriksson ([2012](https://ranabr.people.stanford.edu/sites/g/files/sbiybj26066/files/media/file/abe_ageofmassmigration.pdf), [2014](https://ranabr.people.stanford.edu/sites/g/files/sbiybj26066/files/media/file/abe_assimilation_1.pdf), [2017](https://ranabr.people.stanford.edu/sites/g/files/sbiybj26066/files/media/file/return-migrants.pdf)).
...
data_path <-  '/global/scratch/p2p3/pl1_demography/censoc_internal/enlistment_records_linking/matched_enlistment_datasets_v1.1/public_census_enlistment_links.csv'
