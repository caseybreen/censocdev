...
**Description:** fname is a character variable reporting a person’s first name, as recorded in the World War II Army Enlistment Records. This variable was cleaned from raw first names by removing titles (e.g., Dr.), non-alphabetical characters, and replacing nicknames with standard names (e.g., Billy to William.)
...
**Description**: mname is a character variable reporting a person’s middle name or middle initial, as recorded in the World War II Army Enlistment Records. This variable was cleaned from raw names by removing non-alphabetic characters.
...
**Description**: lname is a character variable reporting a person’s last name, as recorded in the World War II Army Enlistment Records. This variable was cleaned and standardized by removing non-alphabetic characters and whitespace (e.g., O'Connor to oconnor and Villa-Lobos to villalobos).
