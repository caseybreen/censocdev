...
|  \hyperlink{page.23}{23} |\hyperlink{page.23}{weight\_before\_1943}                |Weight (pounds)|
...
**Summary:** The Berkeley Unified WWII Military Enlistment Database captures 9,039,840 of the 15 million enlistees of World War II. The dataset contains 22 variables on demographic information of the men and women enlisted in the United States Army and the Women’s Army Auxiliary Corps. 
...
\newpage
**\huge weight_before_1943**
\normalsize
\vspace{12pt}


**Description**: weight_before_1943 is a numeric variable that reports a person's weight in pounds at time of enlistment as reported in the World War II Army Enlistment Records. This variable is only available for enlistees who enlisted before the year 1943. Weight is filtered to a minimum of 105 pounds, the minimum permissible weight for a 60-inch-tall enlistee ([\textcolor{blue}{Foster et al, 1967}](https://apps.dtic.mil/sti/pdfs/ADA291761.pdf)). While there was no clear maximum body weight for army enlistees, we have removed values of over 500.

**Note**: On enlistment punchcards, the field used to record weight was also used for Army General Classification Test (AGCT) scores, and may also encode military occupation or other information. Weight may have been recorded through about 1943 at some enlistment sites, but the recording of AGCT score instead of weight at some enlistment sites likely began in early 1943. Because of this ambiguity, we only make this variable available for enlistees who enlisted before 1943. 
Refer to the [\textcolor{blue}{National Archives' technical documentation on the Amy Serial Number Electronic File}](https://catalog.archives.gov/id/1263923) for further information. For enlistees who enlisted starting in January 1943, we have created an additional variable called **weight_or_AGCT**.

```{r, include = F}
weight_plot <- enlistment_records_final %>%
  ggplot(aes(x = weight_before_1943)) +
...
**Note**: On enlistment punchcards, this field used to record weight was also used for Army General Classification Test (AGCT) scores, and may also encode military occupation or other information. Weight may have been recorded through about 1943 at some enlistment sites, but the recording of AGCT score instead of weight at some enlistment sites likely began in early 1943. Because of this ambiguity, we created this variable which may record weight or AGCT score for enlistees starting in January 1943. 
Refer to the [\textcolor{blue}{National Archives' technical documentation on the Amy Serial Number Electronic File}](https://catalog.archives.gov/OpaAPI/media/1263923/content/arcmedia/electronic-records/rg-064/asnf/100.1ND_NC.pdf?download=false) for further information. For enlistees prior to January 1943, we used the information recorded in this field to create the **weight_before_1943** variable.
