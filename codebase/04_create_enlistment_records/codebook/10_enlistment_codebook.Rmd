...
**Description**: sex is a numeric variable that reports a person's sex, as inferred by army branch or name using the R package **gender** ([Mullen, 2021](https://cran.r-project.org/web/packages/gender/index.html)).
...
**Note**: Exact number of years of schooling is unknown for enlistees who did not complete at least one year of high school. Such enlistees were given a code meaning "grammar school", though it is unknown if this corresponds to the modern equivalent of a 5th, 6th, or 8th grade education, or whether this code indicates completion or attendance of grammar school. As basic literary was required to enlist in the Army, all enlistees likely had at least some years of elementary education.
...
**Description**: height is a numeric variable that reports a person's height in inches at time of enlistment, as reported in the World War II Army Enlistment Records. Height was filtered based on a reasonable range of numbers compliant with what is permissible for enlistment in the military, 60 - 78 inches ([\textcolor{blue}{Foster et al, 1967}](https://apps.dtic.mil/sti/pdfs/ADA291761.pdf)). 
...
**Label** Weight (pounds) at enlistment 
