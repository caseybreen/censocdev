...
recode states
```{r}
res_state_recode <- recode_res_state_enlistment_to_ipums(df = data_combined) %>% 
...
#add civ_occupation_recode and res_state_recode to data_combined
```{r}
data_combined <- cbind(data_combined, res_state_recode$state_recode)
