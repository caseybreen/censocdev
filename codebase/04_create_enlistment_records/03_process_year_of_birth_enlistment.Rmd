...
```{r}
path_to_temp_data <- "//data/censoc/workspace/enlistment_records/temp2.csv"
...
```{r}
library(here)
ggsave(plot = enliste, filename = here("~/censoc_new/censocdev/codebase/04_create_enlistment_records/dateofenlist.png"), height = 5, width = 9)
```
