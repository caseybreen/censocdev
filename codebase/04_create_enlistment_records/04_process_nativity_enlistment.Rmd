...
nativity_enlistment_recode <- function(df){
  ...
  df <- df %>% 
    ...
    nativity == "L3" ~ 54100, #FRENCH ASIATIC POSSESSIONS or FRENCH INDIA or FRENCH INDO-CHINA or SYRIA	 coded to syria
      ...
      nativity == "46" ~ 52000, #North Carolina	
      ...
      nativity == "08" ~ 25000, #PUERTO RICO (INCLUDING VIRGIN ISLANDS AND CUBA)	
      nativity == "R4" ~ 11000, #PUERTO RICO 	
      nativity == "15" ~ 04400, #RHODE ISLAND	
      nativity == "N5" ~ 45600, #ROUMANIA
      nativity == "O9" ~ 46530, #RUSSIA or UNION OF SOCIALIST SOVIET REPUBLICS 
      nativity == "O9" ~ 46200, #RUSSIA or UNION OF SOCIALIST SOVIET REPUBLICS
      nativity == "O9" ~ 46100, #RUSSIA or UNION OF SOCIALIST SOVIET REPUBLICS
      nativity == "O9" ~ 46000, #RUSSIA or UNION OF SOCIALIST SOVIET REPUBLICS
      nativity == "O9" ~ 45900, #RUSSIA or UNION OF SOCIALIST SOVIET REPUBLICS	
      ...
      nativity == "78" ~ 00100, #SOUTH DAKOTA	   
