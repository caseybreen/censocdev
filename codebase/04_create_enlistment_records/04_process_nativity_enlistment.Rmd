...
```{r}
path_to_temp_data   <-  "//data/censoc/workspace/enlistment_records/temp3.csv"
...
nativity_codes_path <-"/data/josh/CenSoc/censoc_data/enlistment-records-public/data/codes/cl_2079.csv" # should move, update
