...
```{r}
tan_path          <-  here("censocdev/codebase/titles-and-nicknames/")
...
# Extract cleaned name fields only
```{r}
bunmd_clean_name_fields <- bunmd_names_cleaned %>%
...
readr::write_csv(bunmd_clean_name_fields,
          "/censoc/data/numident/4_berkeley_unified_mortality_database/bunmd_clean_name_fields_only.csv")
```
