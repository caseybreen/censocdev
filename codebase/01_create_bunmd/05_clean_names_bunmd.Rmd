...
```{r}
bunmd_cleaned <- fread("/censoc/data/numident/4_berkeley_unified_mortality_database/bunmd_sampled_cleaned.csv")
```
...
clean_names_father <- function(in_path, file_name, lname_col, fname_col, sex_col, other_cols, out_path, middle) {
  ...
  rm(res)
 # Reorder columns, drop unnecessary ones (fname_clean, lname_clean, first, name)
  # Modify cols_to_keep based on the desired column names
  if (middle == "") {
    cols_to_keep <- c("fname_final", "middle", "lname_final", sex_col, fname_col, lname_col, other_cols)
    data_final <- data_final[,cols_to_keep]
    colnames(data_final) <- c("fname", "middle", "lname", "sex", "fname_raw", "lname_raw", other_cols)
    ...
    cols_to_keep <- c("fname_final", "middle", "lname_final", sex_col, fname_col, "middle_raw", lname_col, other_cols)
    data_final <- data_final[,cols_to_keep]
    colnames(data_final) <- c("father_fname", "father_middle", "father_lname", "father_sex", "father_fname_raw", "father_middle_raw", "father_lname_raw", other_cols)
  }
...
fwrite(bunmd_cleaned, "/censoc/data/numident/4_berkeley_unified_mortality_database/bunmd_sampled_f.csv")
...
other_cols_f <- c("fname","middle","lname","sex","fname_raw","middle_raw","lname_raw", "ssn","zip_residence","byear","dyear","socstate","bmonth","dmonth","bday","dday",
                "number_apps","race_first","race_last","race_last_cyear","race_first_cyear",
                "race_last_cmonth","race_first_cmonth","race_change","number_claims","bpl",
...
#Check cleaned dataset 
```{r}
bunmd_cleaned_f <- fread("/censoc/data/numident/4_berkeley_unified_mortality_database/bunmd_sampled_f_cleaned.csv")
```
...
clean_names_mother <- function(in_path, file_name, lname_col, fname_col, sex_col, other_cols, out_path, middle) {
 ...
 # Reorder columns, drop unnecessary ones (fname_clean, lname_clean, first, name)
  ...
  if (middle == "") {
    ...
    cols_to_keep <- c("fname_final", "middle", "lname_final", sex_col, fname_col, "middle_raw", lname_col, other_cols)
    data_final <- data_final[,cols_to_keep]
    colnames(data_final) <- c("mother_fname", "mother_middle", "mother_lname", "mother_sex", "mother_fname_raw", "mother_middle_raw", "mother_lname_raw", other_cols)
  }
...
out_path_f      <- "/censoc/data/numident/4_berkeley_unified_mortality_database"
other_cols_f <- c("fname","middle","lname","sex","fname_raw","middle_raw","lname_raw","father_fname",
                  "father_middle","father_lname","father_sex","father_fname_raw",
                  "father_middle_raw","father_lname_raw",
                  "ssn","zip_residence",
...
```{r}
bunmd_names_cleaned <- bunmd_cleaned_m[,c("fname","middle","lname","fname_raw","middle_raw","lname_raw","sex","ssn","zip_residence","byear","dyear","socstate","bmonth","dmonth","bday","dday","number_apps","race_first","race_last","race_last_cyear","race_first_cyear","race_last_cmonth","race_first_cmonth","race_change" , "number_claims","bpl", "age_first_application","death_age","weight","ccweight","bpl_string","socstate_string",
                   "father_fname","father_middle","father_lname","father_fname_raw","father_middle_raw","father_lname_raw","father_sex","mother_fname","mother_middle","mother_lname","mother_fname_raw","mother_middle_raw","mother_lname_raw","mother_sex")]
