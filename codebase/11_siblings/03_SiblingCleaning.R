...
standard_siblings <- fread("/global/scratch/p2p3/pl1_demography/censoc/workspace/SiblingsCreationClean/02a_StandardSiblings.csv")
jaro_siblings <- fread("/global/scratch/p2p3/pl1_demography/censoc/workspace/SiblingsCreationClean/02b_JaroSiblings_80.csv")
...
#Write data
fwrite(standard_siblings, "/global/scratch/p2p3/pl1_demography/censoc/workspace/SiblingsCreationClean/03_StandardSiblings.csv")
fwrite(jaro_siblings, "/global/scratch/p2p3/pl1_demography/censoc/workspace/SiblingsCreationClean/03_JaroSiblings_80.csv")
