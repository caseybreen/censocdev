...
```{r, include=FALSE, echo = FALSE}
# Read BUNMD data
bunmd_sibs_exact <- fread("/data/censoc/censoc_data_releases/siblings/siblings_v1/bunmd_siblings_v1/bunmd_sibs_exact_match_v1.csv")
bunmd_sibs_flex <- fread("/data/censoc/censoc_data_releases/siblings/siblings_v1/bunmd_siblings_v1/bunmd_sibs_flexible_match_v1.csv")
```
...
df <- tibble(
             ...
             "Number of sibships" = c("2,130,398 ", "2,706,858"),
...
# Read BUNMD siblings IDs
bunmd_sib_id <- fread("bunmd_sibs_flexible_match_v1.csv")
